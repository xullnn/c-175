const nextId = require("./next-id"); // used by List instances not todo instances
...
class TodoList {
  ...
  _validateIndex(index) { // _ in name indicates "private" method
    if (!(index in this.todos)) { // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/in
